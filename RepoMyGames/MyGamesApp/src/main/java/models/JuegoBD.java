...
public class JuegoBD {
	...
	public JuegoBD(int idJuego, String titulo, String descripcion, String fechaLanzamiento, boolean creadoPorUsuario,
			int tiempoJugado, String desarrolladores, byte[] imagenPrincipal, byte[] imagenSecundaria, byte[] imagenTerciaria,
			byte[] imagenCuarta, byte[] imagenQuinta, String pegi, String generos, List<String> plataformas) {
