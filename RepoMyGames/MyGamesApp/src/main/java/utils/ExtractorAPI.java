...
public class ExtractorAPI {
	...
	public static List<Integer> getJuegosIDs(int pages) {
	...
	public static void main(String[] args) {
		...
		List<Integer> gameIds = getJuegosIDs(1);
		...
		for (int gameId : gameIds) {
			System.out.println(obtenerPrimeraCaptura(gameId));
	...
	public static List<String> obtenerPrimeraCaptura(int gameId) {
	    List<String> screenshotsUrl = new ArrayList<String>();
	    try {
	        String detallesUrl = String.format(API_URL_1JUEGO, gameId);
	        URL url = new URL(detallesUrl);
	        HttpURLConnection connection = (HttpURLConnection) url.openConnection();
