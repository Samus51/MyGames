...
public class RegistroController {
	...
	public void initialize() {
		...
		// Escuchar los géneros seleccionados
		lstGeneros.getCheckModel().getCheckedItems().addListener((InvalidationListener) c -> {
			System.out.println("Seleccionados: " + lstGeneros.getCheckModel().getCheckedItems());
		});
	}
